            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-3 h-3 rounded-full bg-accent-cool mt-1" />
                  <div>
                    <p className="font-body text-gray-darkest text-sm font-light mb-1">Teen Program: $150</p>
                    <p className="font-body text-gray-dark text-xs font-light">9:00 AM – 5:00 PM (Ages 14+)</p>
                  </div>
                </div>
              </div>
            </div>
