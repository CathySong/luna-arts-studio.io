...
export const metadata: Metadata = {
  title: "Luna Arts Studio — Fine Art & Creative Classes",
  description:
    "Luna Arts Studio offers fine art exhibitions, painting and drawing classes, and a vibrant creative community. Explore our gallery and join our weekly classes.",
  keywords:
    "art studio, painting classes, drawing, fine art, art gallery, creative classes, New Jersey",
  openGraph: {
    title: "Luna Arts Studio",
    description: "Fine Art & Creative Classes — Basking Ridge, NJ",
    type: "website",
    siteName: "Luna Arts Studio",
  },
  twitter: {
